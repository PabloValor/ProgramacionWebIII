...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_Principal" runat="server">
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidatorNombre" runat="server" ErrorMessage="Ingrese un nombre" ControlToValidate="txtNombre">*</asp:RequiredFieldValidator>
    <asp:RegularExpressionValidator ID="RegularExpressionValidatorNombre" runat="server" ErrorMessage="Ingrese en nombre solo letras" ControlToValidate="txtNombre" ValidationExpression="^[a-zA-Z ]*$">*</asp:RegularExpressionValidator>

    <asp:Label ID="label2" runat="server" Text="Apellido: "></asp:Label>
    <asp:TextBox ID="txtApellido" runat="server" ClientIDMode="Static"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidatorApellido" runat="server" ErrorMessage="Ingrese un apellido" ControlToValidate="txtApellido">*</asp:RequiredFieldValidator>
    <asp:RegularExpressionValidator ID="RegularExpressionValidatorApellido" runat="server" ErrorMessage="Ingrese en apellido solo letras" ControlToValidate="txtApellido" ValidationExpression="^[a-zA-Z ]*$">*</asp:RegularExpressionValidator>
    ...
    <asp:RegularExpressionValidator Display = "Dynamic" ControlToValidate = "txtContrasenia" ID="RegularExpressionValidatorContrasenia" ValidationExpression = "^[A-Z].*(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,20}$" runat="server" ErrorMessage="Contraseña - Caracteres : 8 Minimo, 20 Maximo. Debe comenzar con una mayuscula y contener un numero ">*</asp:RegularExpressionValidator>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidatorConfContrasenia" runat="server" ErrorMessage="Ingrese una contraseña" ControlToValidate="txtConfContrasenia">*</asp:RequiredFieldValidator>
    <asp:CompareValidator ID="CompareValidatorConfContrasenia" runat="server" ErrorMessage="Ingrese Contrasenias iguales" ControlToCompare="txtContrasenia" ControlToValidate="txtConfContrasenia">*</asp:CompareValidator>
