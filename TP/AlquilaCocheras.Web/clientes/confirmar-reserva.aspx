            ...
            <div class="card-content center-align">
                ...
                <div class="row">
                    <div class="col s12 m6">
                        ...
                        <p>
                            <asp:Label ID="lblPrecioHora" ClientIDMode="Static" runat="server">Precio por hora: $<%= Cochera.PrecioPorHora %>.-</asp:Label>
                        </p>
                        <p>
                            <asp:Label ID="lblPrecioTotal" ClientIDMode="Static" runat="server">Precio total: $<%= Cochera.PrecioPorHora * (DateTime.Now.AddHours(4) - DateTime.Now).Hours %>.-</asp:Label>
                        </p>
